...
func setupRoutes(app *fiber.App) {
    ...
    app.Post("/about/query/zones-above-avg-capacity", handlers.ReportZonesAboveAvgCapacity)
	...
	app.Post("/api/v1/reports/zones-above-avg-capacity", handlers.ReportZonesAboveAvgCapacity)
